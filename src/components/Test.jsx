    ...
    <div className="custom-bordered-div">
      ...
      >
        <SwiperSlide
          className="px-3"
          style={{
            backgroundImage: "url(doctor-holding.png)",
        ...
        >
          <div className="ms-5 mt-5 ">
            <div className="text ">
              <h3>Welcome to Saifee Hospital</h3>
              <p>
                At Saifee Hospital, we are dedicated to providing exceptional
                healthcare services to our community. Our team of experienced
                doctors and nurses is committed to ensuring that you receive the
                best possible care in a compassionate and supportive
                environment.
              </p>
              <button
                className="btn"
        ...
        >
          <div className="ms-5 mt-5 ">
            <div className="text ">
              <h3>Welcome to Saifee Hospital</h3>
              <p>
                With state-of-the-art facilities and a wide range of medical
                services, we strive to meet all your health needs. Whether you
                require emergency care, routine check-ups, or specialized
                treatments, Saifee Hospital is here for you.
              </p>
              <button
                className="btn"
                style={{
